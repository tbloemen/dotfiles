...
local theme_dir = os.getenv("HOME") .. "/.config/awesome/themes/powerarrow/"
...
local globalkeys = gears.table.join(
	...
	end, { description = "jump to workspace with client", group = "launcher" }),
	...
	awful.key({ modkey }, "r", function()
		awful.util.spawn("rofi -modes -show drun")
...
awful.spawn.with_shell("flatpak run io.github.mimbrero.WhatsAppDesktop")
