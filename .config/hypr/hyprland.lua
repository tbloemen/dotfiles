...
hl.config({
	general = {
		...
		col = {
			active_border = { colors = { "#cba6f7", "#cba6f7" }, angle = 45 },
...
hl.window_rule({
	name = "prevent-gitkraken-from-going-fullscreen",
...
hl.window_rule({
	name = "fix-musescore",
	match = { class = "org.musescore.MuseScore" },
